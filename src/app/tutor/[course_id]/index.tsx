    ...
    >
      ...
      >
        ...
        <Pressable
          ...
          className={`w-full py-4 rounded-2xl items-center active:scale-[0.98] mb-4 ${
        ...
        <Pressable
          ...
          className="w-full py-4 rounded-2xl items-center border border-primary active:scale-[0.98]"
        >
